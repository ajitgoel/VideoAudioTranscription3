...
namespace TranscribeUploadedFile
{
    ...
    public class TranscribeUploadedFile
    {
      ...
      public TranscribeUploadedFile(IAmazonS3 iAmazonS3, string region, string aws_access_key_id, string aws_secret_access_key)
      {
        this.region = region;
